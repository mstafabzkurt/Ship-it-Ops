...
export const RANKS: Rank[] = [
  ...
  { id: 'junior-ii', name: 'Junior Mühendis II', threshold: 500, tier: 'junior' },
  { id: 'junior-iii', name: 'Junior Mühendis III', threshold: 1200, tier: 'junior' },
  { id: 'engineer-i', name: 'Mühendis I', threshold: 2000, tier: 'engineer' },
  { id: 'engineer-ii', name: 'Mühendis II', threshold: 3200, tier: 'engineer' },
  { id: 'engineer-iii', name: 'Mühendis III', threshold: 4800, tier: 'engineer' },
  { id: 'senior-i', name: 'Kıdemli Mühendis I', threshold: 7000, tier: 'senior' },
  { id: 'senior-ii', name: 'Kıdemli Mühendis II', threshold: 9500, tier: 'senior' },
  { id: 'senior-iii', name: 'Kıdemli Mühendis III', threshold: 12500, tier: 'senior' },
  { id: 'lead-i', name: 'Takım Lideri I', threshold: 16000, tier: 'lead' },
  { id: 'lead-ii', name: 'Takım Lideri II', threshold: 20000, tier: 'lead' },
  { id: 'lead-iii', name: 'Takım Lideri III', threshold: 24500, tier: 'lead' },
  { id: 'manager-i', name: 'Müh. Müdürü I', threshold: 29500, tier: 'manager' },
  { id: 'manager-ii', name: 'Müh. Müdürü II', threshold: 35000, tier: 'manager' },
  { id: 'manager-iii', name: 'Müh. Müdürü III', threshold: 41000, tier: 'manager' },
  { id: 'director-i', name: 'Direktör I', threshold: 47500, tier: 'director' },
  { id: 'director-ii', name: 'Direktör II', threshold: 54500, tier: 'director' },
  { id: 'director-iii', name: 'Direktör III', threshold: 62000, tier: 'director' },
  { id: 'cto-i', name: 'CTO I', threshold: 70000, tier: 'cto' },
  { id: 'cto-ii', name: 'CTO II', threshold: 79000, tier: 'cto' },
  { id: 'cto-iii', name: 'CTO III', threshold: 89000, tier: 'cto' },
];
